...
function Navbar({ links, ctaText, aboutRef, contactRef }) {
  ...
  return (
    <nav className="w-full bg-black sticky top-0 backdrop-blur-md shadow-md z-50">
      ...
      {/* Mobile Slide Drawer */}
      <div
        className={`md:hidden fixed top-0 right-0 h-full w-64 bg-black border-l border-gray-800 shadow-xl z-40 transform
      ...
      >
        ...
        {/* Drawer Content */}
        <div className="flex flex-col items-center space-y-6 py-14 bg-black">
